...
********************************************************************************
    ...
    File info:
        ...
        Project File: g431b-esc.xdd
        File Version: 1

        Created:      24/10/2025 10:00:24 pm
        Created By:   
        Modified:     8/11/2025 3:58:03 pm
        Modified By:  

    Device Info:
        Vendor Name:  
        Vendor ID:    
        Product Name: g431b-esc
        Product ID:   
...
typedef struct {
    ...
    float32_t x2000_testObject_F32;
    float64_t x2001_testObject_F64;
} OD_RAM_t;
...
#define OD_ENTRY_H2000_testObject_F32 &OD->list[34]
#define OD_ENTRY_H2001_testObject_F64 &OD->list[35]
