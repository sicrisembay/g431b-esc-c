...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1008_manufacturerDeviceName = {'S', 'T', 'M', '3', '2', 'G', '4', '3', '1', '-', 'E', 'S', 'C', 0},
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2000_testObject_F32 = 123.456,
    .x2001_testObject_F64 = 123456.789
};
...
typedef struct {
    ...
    OD_obj_var_t o_2000_testObject_F32;
    OD_obj_var_t o_2001_testObject_F64;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_testObject_F32 = {
        .dataOrig = &OD_RAM.x2000_testObject_F32,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_2001_testObject_F64 = {
        .dataOrig = &OD_RAM.x2001_testObject_F64,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 8
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x01, ODT_VAR, &ODObjs.o_2000_testObject_F32, NULL},
    {0x2001, 0x01, ODT_VAR, &ODObjs.o_2001_testObject_F64, NULL},
